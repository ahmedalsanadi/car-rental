    ...
    const steps = [
        {
            ...
            description:
                'Browse our extensive fleet and compare cars based on your preferences, budget, and needs.',
            step: '01',
        },
        {
            icon: Calendar,
            title: 'Select Dates',
            description:
                'Choose your pickup and drop-off dates, times, and locations that work best for you.',
            step: '02',
        },
        {
            icon: Car,
            title: 'Book Your Car',
            description:
                'Complete your reservation with our secure booking system and receive instant confirmation.',
            step: '03',
        },
        {
            icon: Key,
            title: 'Drive Away',
            description:
                'Pick up your keys and hit the road! Our team will ensure your car is ready to go.',
            step: '04',
        },
    ];
