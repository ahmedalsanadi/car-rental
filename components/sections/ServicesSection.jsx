    ...
    const services = [
        {
            ...
            description:
                'Comprehensive insurance coverage for complete peace of mind during your rental period.',
        ...
        },
        {
            ...
            description:
                'Professional staff ready to help you choose the perfect vehicle for your needs.',
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <motion.div
                    ...
                    <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                        We provide exceptional service and value to make your
                        car rental experience smooth, reliable, and enjoyable.
                    </p>
                </motion.div>
                ...
                <motion.div
                    ...
                    <div className="bg-gradient-to-r from-primary-500 to-primary-600 rounded-2xl p-8 text-white">
                        ...
                        <p className="text-lg mb-6 opacity-90">
                            Book your perfect car today and experience the
                            difference with RentCar.
                        </p>
                        <a
                            href="/cars"
