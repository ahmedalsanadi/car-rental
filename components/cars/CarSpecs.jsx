  ...
  const specifications = [
    {
      ...
      specs: [
        ...
        { label: 'Color', value: car.color || 'Available in multiple colors' }
      ]
    },
    {
    ...
    },
    {
      ...
      specs: [
        ...
        { label: 'Tank Capacity', value: car.tankCapacity || '18.5 gallons' },
        { label: 'Range', value: car.range || '450 miles' },
        { label: 'Emissions', value: car.emissions || 'Euro 6 compliant' }
      ]
    },
    {
      category: 'Drivetrain',
      ...
      specs: [
        ...
        { label: 'Drive Type', value: car.driveType || 'Front-wheel drive' },
    ...
    },
    {
      ...
      icon: Shield,
      specs: [
        { label: 'Safety Rating', value: car.safetyRating || '5-Star NHTSA' },
        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <ul className="text-blue-800 text-sm space-y-1">
              <li>• All specifications are approximate and may vary by trim level</li>
              <li>• Fuel economy figures are EPA estimates</li>
              <li>• Vehicle features may vary based on availability</li>
              <li>• Please verify specific features with our rental team</li>
            </ul>
          </div>
        </div>
      </div>
