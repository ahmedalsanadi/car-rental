...
const cars = [
  {
    ...
    description: 'Experience luxury and performance with this premium BMW X5. Perfect for family trips or business travel.',
    rating: 4.8,
    reviews: 126,
    available: true,
    location: 'Downtown',
  ...
  },
  {
    ...
    features: ['GPS Navigation', 'Bluetooth', 'Heated Seats', 'Premium Audio'],
    description: 'Elegant and comfortable Mercedes-Benz C-Class perfect for city driving and long journeys.',
    rating: 4.7,
    reviews: 89,
    available: true,
    location: 'Airport',
  ...
  },
  {
    ...
    description: 'Sophisticated Audi A4 with cutting-edge technology and superior comfort.',
    rating: 4.6,
    reviews: 73,
    available: true,
    location: 'Downtown',
  ...
  },
  {
    ...
    description: 'Reliable and fuel-efficient Toyota Camry Hybrid, perfect for everyday use.',
    rating: 4.5,
    reviews: 94,
    available: true,
    location: 'Suburban',
  ...
  },
  {
    ...
    features: ['GPS Navigation', 'Bluetooth', 'Sport Mode', 'Premium Audio'],
    description: 'Iconic Ford Mustang with powerful performance and classic American muscle car appeal.',
    rating: 4.7,
    reviews: 156,
    available: true,
    location: 'Downtown',
  ...
  },
  {
    ...
    features: ['GPS Navigation', 'Bluetooth', 'Backup Camera', 'All-Wheel Drive'],
    description: 'Versatile Honda CR-V SUV with excellent safety ratings and spacious interior.',
    rating: 4.6,
    reviews: 112,
    available: true,
    location: 'Airport',
  ...
  },
  {
    ...
    description: 'Revolutionary Tesla Model 3 with advanced autopilot and zero emissions.',
    rating: 4.8,
    reviews: 203,
    available: true,
  ...
  },
  {
    ...
    description: 'Adventure-ready Jeep Wrangler perfect for off-road exploration and outdoor activities.',
    rating: 4.5,
    reviews: 87,
    available: true,
...
export const getAllBookings = async () => {
  ...
  const enrichedBookings = bookings.map(booking => {
    ...
    return {
      ...
      car: car ? { name: car.name, brand: car.brand, model: car.model } : null
    };
  });
...
export const getBookingsByCustomerId = async (customerId) => {
  ...
  const customerBookings = bookings.filter(booking => booking.customerId === parseInt(customerId));
  ...
  const enrichedBookings = customerBookings.map(booking => {
    ...
    return {
      ...booking,
      car: car ? { name: car.name, brand: car.brand, model: car.model, images: car.images } : null
    };
  });
...
export const getRelatedCars = async (carId, type) => {
  await delay(200);
  return cars.filter(car => car.id !== parseInt(carId) && car.type === type).slice(0, 4);
};